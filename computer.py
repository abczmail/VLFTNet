...
if __name__ == '__main__':
    ...
    data = torch.load('./saved_transformer_models/S2_w_1_ga_goa_relu_last.pth')

    model.load_state_dict({k.replace('module.', ''): v for k, v in data['state_dict'].items()})

    # net即你需要测试的模型
    flop, param = get_model_complexity_info(model, (50, 49, 2048), as_strings=True, print_per_layer_stat=False)
